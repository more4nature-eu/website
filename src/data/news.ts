...
const NEWS: News[] = [
  ...
  },
  {
    ...
    categories: [ThematicArea.ZERO_POLLUTION],
  ...
  {
    name: 'polli.NET IV Annual Meeting',
    date: '2024-06-26',
    description:
      "<p>Cristina Luís and Esther Marín González presented the more4nature project at polli.NET's IV Annual Meeting. We are grateful to João Loureiro and Sílvia Castro for inviting Cristina from Faculdade de Ciências da Universidade de Lisboa to showcase our work. More4nature collaborated with PolinizAÇÃO in Portugal on citizen science and the Pollinator Action Plan, coordinated by the FLOWer Lab, Centre for Functional Ecology - Science for People & the Planet. We remained committed to empowering communities through citizen science for environmental conservation, zero pollution, biodiversity protection, and deforestation prevention.</p>",
    categories: [ThematicArea.BIODIVERSITY_PROTECTION],
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7211646731254419456',
  },
  {
  ...
  },
  {
    ...
    categories: [ThematicArea.DEFORESTATION_PREVENTION],
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7214292712999546880',
  },
];
